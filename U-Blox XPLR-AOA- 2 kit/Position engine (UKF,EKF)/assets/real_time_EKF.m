...
% real_time_EKF is a MATLAB function for real-time processing of sensor data
% from multiple serial ports and updating position estimates using 
% Extended Kalman Filtering (EKF) techniques.

function real_time_EKF(port, port1 ,port2 ,port3,x0,Q,X_anchor,Y_anchor,orientation,sigma_theta)
...
ukf = Inititaliztion_filter_EKF(x0,sigma_theta,Q,ref_points,dt);
